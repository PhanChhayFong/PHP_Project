<div class="product-section mt-150 mb-150">
     <div class="container">
          <div class="row">
               <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="section-title">
                         <h3><span class="orange-text">Hot Sale</span> Products</h3>
          ...
          <div class="row sales-product">
               ...
               $order = "ORDER BY pd_salePrice DESC limit 8";
                    ...
                    foreach ($products as $product) {
                         ...
                         <div class="col-6 text-center">
                              <div class="single-product-item">
                                   <p class="float-start btn-badge-new bg-warning px-3 py-2 text-light">sale</p>
