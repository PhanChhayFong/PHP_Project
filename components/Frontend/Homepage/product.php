                         ...
                         <div class="col-lg-4 col-md-6 text-center">
                              <div class="single-product-item" style="height:550px">
                                   ...
                                   if ($product['pd_salePrice'] == 0) {
                                        ?>
                                        <p class="float-start btn-badge-new bg-warning px-3 py-2 text-light">new</p>
                                        <?php
                                   } else {
                                        ?>
                                        <p class="float-start btn-badge-sale bg-warning px-3 py-2 text-light">sale</p>
                                        <?php
                                   }
                                   ?>
                                   <div class="product-image">
                                        <a href="/shop/product-detail?productid=<?php echo $product['pd_id']; ?>">
                                             <img src="./assets/images/<?= strtolower($heading) ?>/<?= $product['pd_image'] ?>" height="250">
                                        </a>
                                   </div>
                                   <h3>
                                   ...
                                   if (!empty($product['pd_salePrice'])) {
                                        ...
                                        <p class="product-price d-flex justify-content-center fw-bold sale-price">
                                   ...
                                   <form action="../../../DB/frontend/add-to-cart.php" method="POST">
                                        ...
                                        <button type="submit" style="border:0px; background-color: transparent;">
                                             <a name="add-to-cart" class="cart-btn"><i
