...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
  ...
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" data-toggle="collapse" href="#commerce" aria-expanded="false" aria-controls="ui-basic">
        <span class="menu-icon">
      ...
      <div class="collapse" id="commerce">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="/admin_product"> <i class="fas fa-archive me-2"></i>
              Product</a>
          </li>
          <li class="nav-item"> <a class="nav-link" href="/admin_order"> <i class="fas fa-sort-amount-up-alt me-2"></i>
              Order</a></li>
          <li class="nav-item"> <a class="nav-link" href="/admin_category"> <i class="fas fa-calendar-day me-2"></i>
              Category
            </a></li>
        </ul>
      </div>
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="configuration">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="/admin_company"> <i class="fas fa-building me-2"></i> Company
            </a>
          </li>
          <li class="nav-item"> <a class="nav-link" href="/admin_user"> <i class="fas fa-user me-2"></i> User </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item menu-items">
