                    ...
                    <div class="col-md-7">
                         <div class="single-product-content">
                              ...
                              if (!empty($product['pd_salePrice'])) {
                                   ...
                                   <p class="d-flex justify-content-start fw-bold sale-price">
                                   ...
                                   ?>
                                        <p class="product-price regular-price"><span>Per Kg</span>
                                        <?php echo number_format($product['pd_regularPrice'], 2); ?>$
                                        </p>
                                   <?php
                              }
                              ...
                              <div class="single-product-form">
                                   <form action="../../DB/frontend/add-to-cart.php" method="POST">
                                        ...
                                        <button type="submit" name="add-to-cart"
                                             class="cart-btn <?= $product['pd_countInStock'] == 0 ? 'd-none' : '' ?>"><i
                                   ...
                                   <div class="single-product-item">
                                        <div class="product-image" style="height:250px">
                                             <a href="/shop/product-detail?productid=<?php echo $related_product['pd_id']; ?>">
                                                  <img
                                                       src="../assets/images/<?= strtolower($heading) ?>/<?= $related_product['pd_image'] ?>">
                                             </a>
                                        </div>
                                        <h3>
                                             <?php echo $related_product['pd_name']; ?>
                                        </h3>
                                        <?php
                                        if (!empty($related_product['pd_salePrice'])) {
                                             ...
                                             <p class="d-flex justify-content-center fw-bold sale-price">
                                                  <?php echo number_format($related_product['pd_salePrice'], 2); ?>$
                                                  <span class="text-decoration-line-through ms-3 text-secondary">
                                                       <?php echo number_format($related_product['pd_regularPrice'], 2); ?>$
                                                  </span>
                                             </p>
                                             <?php
