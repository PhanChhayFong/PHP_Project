                    ...
                    if (!empty($cart_tiems)) {
                                                  ...
                                                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                                       ...
                                                       <div class="card-body">
                                                            <div class="billing-address-form">
                                                                 ...
                                                                 <input type="hidden" name="od_id" value="<?= $order_id + 1; ?>"
                                                                      class="form-control">
                                                                 <div class="row">
                                                                      <div class="col-6">
                                                                           <input type="text" name="firstname"
                                                                                class="form-control py-3 mb-3" required
                                                                 ...
                                                                 <input type="email" name="email" class="form-control py-3 mb-3"
                                                                      required placeholder="Email">
                                                                 <input type="tel" name="phone" class="form-control py-3 mb-3"
                                                  ...
                                                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                       ...
                                                       <div class="card-body">
                                                            <div class="shipping-address-form">
                                                                 <input type="text" name="city" class="form-control py-3 mb-3"
                                                                      required placeholder="City">
                                                                 <input type="text" name="country" class="form-control py-3 mb-3"
                                                                      required placeholder="Country">
                                                                 <textarea name="shippingAddress" rows="3"
                                                                      class="form-control py-3" style="resize: none" required
                                                                      ...
                                                                      <div class="summary-item payment-method w-100">
                                                                           <div class="wrap-address-billing">
                                                                                ...
                                                                                <div class="row">
                                                                                     <div class="col-6 mb-3">
                                                                                          <label
                                                                                               class="mb-2 fw-bold text-capitalize"
                                                                                               for="card-no">Card Number</label>
                                                                           ...
                                                                           <div class="choose-payment-methods mt-3">
                                                                                ...
                                                                                <label class="payment-method w-100 mb-3">
                                                                                     ...
                                                                                     <p class="payment-desc">Order Now Pay On
                                                                                          Delivery</p>
                                                                                </label>
                                                                                <label class="payment-method w-100 mb-3">
                                                                                     <input type="radio" name="payment-method"
                                                                                          value="card" class="payment-method-visa"
                                                                                          id="payment-method-visa">
                                                                                     <span class="fw-bold">Debit / Credit
                                                                                          Card</span>
                                                                                     <p class="payment-desc">There are many
                         ...
                         ?>
                              <div class="text-center">
                                   ...
                                   <a href="/shop" class="btn btn-success text-center px-3 py-2 fw-bold"><i
