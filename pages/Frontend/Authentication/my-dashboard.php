          ...
          <div class="col-lg-4 col-md-6">
               <div class="single-latest-news">
                    <div class="latest-news-bg news-bg-1"
                         style="background-image: url(../../assets/frontend/img/dashboard/bg-1.jpg)"></div>
                         ...
                         <div class="row my-auto">
                              ...
                              <div class="col-md-8 text-end">
                                   <div class="card-body">
                                        ...
                                        <h4 class="card-text text-light fw-bold">$
          ...
          <div class="col-lg-4 col-md-6">
               <div class="single-latest-news">
                    <div class="latest-news-bg news-bg-2"
                         style="background-image: url(../../assets/frontend/img/dashboard/bg-2.jfif)"></div>
                    <div class="card mb-3 py-3 dashboard-item">
                         <div class="row my-auto">
                              <div class="col-md-4 my-auto text-center">
                              ...
                              <div class="col-md-8 text-end">
                                   <div class="card-body">
                                        ...
                                        <h4 class="card-text text-light fw-bold">
                                             <?= $total_purchased; ?>
                                             <?= $total_purchased == 0 || $total_purchased == 1 ? ' Item' : ' Items' ?>
                                        </h4>
                                   </div>
                              </div>
                         </div>
          ...
          <div class="col-lg-4 col-md-6">
               <div class="single-latest-news">
                    <div class="latest-news-bg news-bg-3"
                         style="background-image: url(../../assets/frontend/img/dashboard/bg-3.jpg)"></div>
                    <div class="card mb-3 py-3 dashboard-item">
                         <div class="row my-auto">
                              <div class="col-md-4 my-auto text-center">
     ...
     if (!empty($orders)) {
                              ...
                              <div class="card mb-3 py-3 border border-danger" style="border: 5px solid #dc3545 !important">
                                   <div class="row my-auto">
                                        <div class="col-md-5 my-auto text-center">
                                             <img style="background-image: url('../../assets/images/<?= strtolower($heading) ?>/<?= $order['us_image']; ?>')"
                                                  class="order-item-profile">
                                             <div class="px-3 mt-3 mb-2">
                                                  <h6 class="bg-danger fw-bold my-2 py-1 text-light">Ordered</h6>
                                             </div>
                                             <p>
                                                  <a href="/my-dashboard/order-detail?orderid=<?= $order['od_id']; ?>"
                                                       class="btn btn-primary btn-sm text-light fw-bold"><i
                                                            class="fas fa-eye me-2"></i>Detail</a>
                                             </p>
                                        </div>
                                        <div class="col-md-7 text-right">
                                             <div class="card-body">
                                                  <p class="m-0 card-title"><span class="fw-bold">No. </span>
                                                       <?= $order['od_id']; ?>
                                                  </p>
                                                  ...
                                                  <p class="m-0 card-text"><a href="mailto:<?= $order['email']; ?>"
                                                            class="text-dark"><?= $order['email']; ?></a></p>
                                                  <p class="m-0 card-text"><a href="tel:<?= $order['phone']; ?>"
                                                            class="text-dark">+(855) <?= $order['phone']; ?></a></p>
                                                  <p class="m-0 card-text fw-bold">$
                                             ...
                                             <div class="col-md-5 my-auto text-center">
                                                  ...
                                                  <div class="d-flex justify-content-center">
                                                       <form action="../../../DB/frontend/accept_delivery.php" method="POST">
                                                            ...
                                                            <button type="submit" name="accept_delivered"
                                                                 class="btn btn-success btn-sm text-light fw-bold me-2"><i
                                                                      class="fa-solid fa-check fw-bold"></i></button>
                                                       </form>
          ...
          ?>
               <div class="text-center text-capitalize py-5">
                    ...
                    <a href="/shop" class="btn btn-sm btn-success py-2 px-3 fw-bold"><i
                              class="fa-solid fa-circle-arrow-left me-2"></i>Shop Now</a>
               </div>
