                    ...
                    <div class="card-body">
                         <div class="row">
                              ...
                              <div class="col-6 mb-4">
                                   <a href="/my-dashboard" class="btn btn-success btn-sm float-end py-2 fw-bold"><i
                                             class="fas fa-circle-arrow-left me-2"></i>Back</a>
                              </div>
                                   ...
                                   <div class="row">
                                        <div class="col-12 mb-3 rounded bg-secondary text-dark p-0">
                                             <div class="card bg-secondary">
                                                  <div class="card-header text-light font-weight-bold">ORDERS DETAILS
                                                  </div>
                                                  <div class="card-body">
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <td>
                                                                           ...
                                                                           if ($order['status'] == "ordered" && $order['dateDelivered'] == "") {
                                                                                ?>
                                                                                     <p class="fw-bold text-danger">The order item
                                                                                          is not deliver ,yet</p>
                                                                                     <?php
                                                                                ...
                                                                                ?>
                                                                                                         <p class="fw-bold text-danger">The order is
                                                                                                              delivered, No Accept, yet</p>
                                                                                     <?php
                              ...
                              <div class="col-md-8">
                                   <div class="row px-3">
                                        <div class="col-12 mb-3 rounded bg-secondary text-dark p-0">
                                             <div class="card bg-secondary">
                                                  <div class="card-header text-light font-weight-bold">PRODUCT ITEMS
                                                  </div>
                                                  <div class="card-body">
                                                                 ...
                                                                 ?>
                                                                      <div class="col-md-4 px-2 bg-secondary">
                                                                           <div class="card mb-3 text-dark"
                                                                                ...
                                                                                <div class="row g-0">
                                                                                     <div
                                                                                          class="col-md-4 my-auto text-center px-2 card-product-img">
                                                                                          <img src="../../../assets/images/<?= strtolower($heading) ?>/<?= $order_detail['pd_image']; ?>"
                                                                                               width="150">
                                                                                     </div>
                                                                                     <div class="col-md-8">
                                                                                          <div class="card-body">
                                                                                               <h6
                                                                                                    class="card-title text-dark m-0">
                                                                                                    <?= $order_detail['pd_name']; ?>
                                                                                               </h6>
                                                                                               <p class="card-text m-0"><span
                                                                                                         class="fw-bold">Amount:</span>
                                                                                                    <?= $order_detail['quantity']; ?>
                                                                                               </p>
                                                                                               <p class="card-text m-0"><span
                                                                                                         class="fw-bold">Unit
                                                                                                         Price:</span> $
                                                                                                    <?= $order_detail['pd_salePrice'] ? number_format($order_detail['pd_salePrice'], 2) : number_format($order_detail['pd_regularPrice'], 2); ?>
                                                                                               </p>
                                        ...
                                        <div class="col-12 mb-3 rounded bg-secondary text-dark p-0">
                                             <div class="card bg-secondary">
                                                  <div class="card-header text-light font-weight-bold">BILLING DETAILS
                                                  </div>
                                                  <div class="card-body">
                                                       <table class="table table-secondary p-0">
                                                            <tbody>
